...
export async function POST(
  ...
  if (existing?.isLocked) return NextResponse.json({ error: "Tie-break policy is locked" }, { status: 422 });
  ...
  // SOP_SCORE → requiresSop=true; any other method → requiresSop=false.
